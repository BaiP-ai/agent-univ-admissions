# University Admissions Reports

This page contains automatically generated reports about university admissions data. These reports provide information about:

- Degree programs offered by universities
- Admissions requirements
- Application deadlines
- Other relevant admissions data

The reports are generated using the [University Admissions Data Generator](https://github.com/BaiP-AI-Private/agent-univ-admissions) tool, which scrapes data from university websites and enhances it using AI.
...
- [University Data 20260901 022509.Markdown](university_data_20260901_022509.markdown)

## How Reports are Generated

These reports are automatically generated through a GitHub Actions workflow that:

1. Scrapes data from university websites
2. Processes and structures the raw data
3. Enhances the structured data using AI (via the GROQ API)
4. Generates human-readable Markdown reports
5. Deploys the reports to GitHub Pages

## Custom Reports

If you'd like to generate a custom report for specific universities, you can:

1. Fork the [repository](https://github.com/BaiP-AI-Private/agent-univ-admissions)
2. Modify the university list in `config.py`
3. Run the generator with your preferred parameters
4. Submit a pull request with your changes

---

*Last updated: 2026-09-01 02:25:25*
